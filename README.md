...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/ZZMHA/v2ray.fun/master/install.sh)"
```

## 升级命令
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/ZZMHA/v2ray.fun/master/upgrade.sh)"
```

## 卸载命令
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/ZZMHA/v2ray.fun/master/uninstall.sh)"
```
